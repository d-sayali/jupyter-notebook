...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(
                ...
                names=exp_rec.index,
                title="Total Expenditure share during Recession period per Vehicle type"
            )
        )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        # unemp_sale= recession_data.groupby("Vehicle_Type")['Advertising_Expenditure'].sum()
        R_chart4 = dcc.Graph(
            figure=px.bar(
                recession_data,
                x="unemployment_rate",
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mas, x='Month',y='Automobile_Sales', title='Average monthly Automobile Sales'))
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                ...
                title="Total Advertisement Expenditure per Vehicle type in {}".format(input_year)
            )
        )
